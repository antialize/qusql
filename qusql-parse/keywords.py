...
with open("src/keywords.rs", "w") as f:
    ...
    f.write("// This file is generated by keywords.py. Do not edit manually.\n")
    f.write("\n")
    f.write("/// A SQL keyword.\n")
    f.write("#[derive(Debug, Clone, Copy, PartialEq, PartialOrd, Eq, Ord, Hash)]\n")
        ...
        if len(keywords) == 1:
            ...
            for (e, kw) in enumerate(keywords + [None]):
                ...
                if c is None:
                    ...
                    f.write(f"{"    "*(i*2+3)}}}\n")
                    s = e
            f.write(f"{"    "*(i*2+3)}_ => Keyword::NOT_A_KEYWORD,\n")
            f.write(f"{"    "*(i*2+2)}}}\n")
    ...
    f.write("}\n")
    f.write("\n")
    f.write("impl Keyword {\n")
    f.write("    pub fn name(&self) -> &'static str {\n")
    f.write("        match self {\n")
    f.write("            Keyword::NOT_A_KEYWORD => \"NOT_A_KEYWORD\",\n")
    f.write("            Keyword::QUOTED_IDENTIFIER => \"QUOTED_IDENTIFIER\",\n")
    for kw in KEYWORDS:
        f.write(f"            Keyword::{kw} => \"{kw}\",\n")
    f.write("        }\n")
    f.write("    }\n")
    f.write("\n")
    f.write("    pub const fn reserved(&self) -> bool {\n")
    ...
    f.write("    }\n")
    f.write("\n")
    f.write("    pub const fn expr_ident(&self) -> bool {\n")
    f.write("        matches!(self,\n")
    first = True
